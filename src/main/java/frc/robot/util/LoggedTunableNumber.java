...
public class LoggedTunableNumber implements DoubleSupplier {
  ...
  /**
   * Ensures the given tunable number key does not already exist. If it does, appends as many numbers as are necessary to make it unique, and reports a warning.
   * @param key
   * @return
   */
